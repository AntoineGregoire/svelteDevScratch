<script lang="ts">
    ...
    function downloadCSVFile(csv_data) {
        ...
        let thisDay = data.shiftsUser[0].shiftStart.split(', ').slice(0,1)
        let tempName = data.shiftsUser[0].userName.split(' ')

        // Download csv file
        temp_link.download = tempName[0]+tempName[1]+thisDay+".csv";
